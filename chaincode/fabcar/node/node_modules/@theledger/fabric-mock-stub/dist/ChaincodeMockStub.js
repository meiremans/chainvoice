...
var ChaincodeMockStub = /** @class */ (function () {
     ...
     * @param {string} txid
     */
    ChaincodeMockStub.prototype.mockTransactionStart = function (txid) {
        this.txID = txid;
     ...
     */
    ChaincodeMockStub.prototype.mockInit = function (uuid, args) {
     ...
     * @returns {Promise<"fabric-shim".ChaincodeReponse>}
     */
    ChaincodeMockStub.prototype.mockInvoke = function (uuid, args) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ChaincodeMockStub.prototype.getStateByRange = function (startKey, endKey) {
        ...
        var items = Object.keys(this.state)
            .filter(function (k) {
            var comp1 = strcmp(k, startKey);
            var comp2 = strcmp(k, endKey);
